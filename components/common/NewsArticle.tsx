          ...
          <div className="mt-8 grid items-start gap-10 lg:mt-10 lg:grid-cols-[minmax(0,900px)_minmax(140px,160px)] lg:gap-8">
            ...
            <div className="min-w-0">
              ...
              {trends.length > 0 && (
                <div className="mt-14 sm:mt-16 lg:mt-20">
                  ...
                  <p className=" mt-2 text-base leading-7 text-[#1A1A1A] sm:text-lg sm:leading-8 lg:text-[19px] lg:leading-[2]">Several major trends are influencing how businesses develop, industries transform and new investment opportunities emerge.</p>
                    ...
                    {trends.map((trend) => (
                      ...
                      >
                        ...
                        <p className="text-base leading-7 text-[#1A1A1A] sm:text-lg sm:leading-8 lg:text-[19px] lg:leading-[2]">
                          {trend.description.map((paragraph, index) => (
              ...
              {beyond && (
                <div className="mt-14 sm:mt-16 lg:mt-20">
                  ...
                  <h2 className="mt-4 w-full max-w-[720px] text-3xl font-semibold leading-tight text-black sm:text-4xl md:text-5xl lg:text-[41px] lg:leading-[1.15]">
                    {beyond.title}
                  </h2>

                  <div className="mt-8 text-base leading-7 text-[#1A1A1A] sm:text-lg sm:leading-8 lg:text-[19px] lg:leading-[2]">
                    {beyond.paragraphs.map((paragraph, index) => (
            ...
            <aside className="w-full min-w-0 text-black lg:pt-1">
              ...
              <div className="mt-6 w-full">
                ...
                <p className="mt-1 w-100 break-words text-base leading-7 text-[#1A1A1A] sm:text-lg sm:leading-8 lg:text-[19px] lg:leading-[2]">
                  {author}
                </p>
